...
async function main() {
  ...
  let js_path = 'https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/drpy_js';
  let live_path = 'https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/lives';
  let config_path = 'https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/custom.json';
  let js_api = 'https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/drpy_libs/drpy2.min.js';
  let parse_apis = [
  ...
  let json_config = {
    ...
    "homeLogo":"https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/img/logo500x200-1.png",
    "spider": "https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/jar/pg.jar?md5=7633f8ea346c082b7aa163be58aed023",
    'sites': [],
    'parses': parses,
    'flags': [
      'imgo',
  ...
  js_files.forEach((it, index) => {
    ...
    if (rname.includes('我的哔哩传参')) {
      extra = '?type=url&params=.https://raw.gitcode.com/PandaTigerC/cc/raw/main/DZ/json/小学教育.json';
    }
